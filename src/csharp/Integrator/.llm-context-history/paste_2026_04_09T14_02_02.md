...
## File Analysis @ 2026-04-09 12:35:32
- Total files: 64
- .cs: 56
- .csproj: 3
- .http: 1
...
---
#### Integrator.sln @ 2026-04-09 12:35:32
```
﻿
...
---
#### TextGenerator.Core/Common/Enums/ItemType.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Common/Enums/StatType.cs @ 2026-04-09 12:35:32
```
﻿namespace TextGenerator.Core.Common.Enums
{
...
---
#### TextGenerator.Core/Common/Enums/Status.cs @ 2026-04-09 12:35:32
```
﻿namespace TextGenerator.Core.Common.Enums
{
    public enum Status
...
---
#### TextGenerator.Core/Common/IEntity.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Interfaces/Cache/IDialogueCache.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Interfaces/EdgeAI/ILLMClient.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Interfaces/Memory/IMemory.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Interfaces/Memory/IRewardCalculator.cs @ 2026-04-09 12:35:32
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Memory/IRewardCollector.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Interfaces/Memory/ISummarizer.cs @ 2026-04-09 12:35:32
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Memory/IVectorMemory.cs @ 2026-04-09 12:35:32
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Narrative/INarrativeAgent.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Models.Actors;
using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Interfaces/Narrative/INarrativeEnvironment.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Interfaces/Processors/IAnalyzer.cs @ 2026-04-09 12:35:32
```
﻿using System;
...
---
#### TextGenerator.Core/Interfaces/Processors/IPostprocessor.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Models.Actors;
using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Interfaces/Processors/IPreprocessor.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Models.Actors;
using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Interfaces/RAG/IRAGService.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Interfaces/RL/IRLFineTuner.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Models/Actions/GameAction.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Models/Actions/GameReaction.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Actions/SocialConnection.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Actors/Player.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Models/Actors/SmartNPC.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Models.Actions;
using TextGenerator.Core.Models.Interactions;
...
---
#### TextGenerator.Core/Models/Actors/WorldContext.cs @ 2026-04-09 12:35:32
```
﻿namespace TextGenerator.Core.Models.Actors;
...
---
#### TextGenerator.Core/Models/Feedback/InteractionFeedback.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Dialogues/DialogueEntry.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Dialogues/DialogueNode.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/Quest.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/QuestChain.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/Requirement.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/Reward.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Models.World;
...
---
#### TextGenerator.Core/Models/Metrics/PersonalizationMetrics.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Core/Models/World/GameObject.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/World/Inventory.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/World/Item.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Common.Enums;
...
---
#### TextGenerator.Core/Models/World/Stat.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Common.Enums;
...
---
#### TextGenerator.Core/TextGenerator.Core.csproj @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Infrastructure/Caching/DialogueCache.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Infrastructure/EdgeAI/LLamaSharpOptions.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Infrastructure/EdgeAI/LocalLLMClient.cs @ 2026-04-09 12:35:32
```
﻿using LLama;
using LLama.Common;
...
---
#### TextGenerator.Infrastructure/EdgeAI/ModelDownloader.cs @ 2026-04-09 12:35:32
```
﻿namespace TextGenerator.Infrastructure.EdgeAI;
...
---
#### TextGenerator.Infrastructure/Extensions/DialogueExtensions.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Models.Interactions;
using System;
using System.Collections.Generic;
...
---
#### TextGenerator.Infrastructure/Memory/QdrantMemory.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Infrastructure/Memory/Summarizer.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/Memory/VectorMemoryService.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Infrastructure/Narrative/Agents/NarrativeAgent.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Infrastructure/Narrative/Environment/NarrativeEnvironmentService.cs @ 2026-04-09 12:35:32
```
﻿using Microsoft.Extensions.Caching.Memory;
using Neo4j.Driver;
using TextGenerator.Core.Interfaces.Narrative;
...
---
#### TextGenerator.Infrastructure/Processors/DialogueAnalyzer.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Infrastructure/Processors/PostprocessorService.cs @ 2026-04-09 12:35:32
```
﻿using System.Text.RegularExpressions;
...
---
#### TextGenerator.Infrastructure/Processors/PreprocessorService.cs @ 2026-04-09 12:35:32
```
﻿using Newtonsoft.Json;
using TextGenerator.Core.Interfaces.Narrative;
using TextGenerator.Core.Interfaces.Processors;
...
---
#### TextGenerator.Infrastructure/RAG/RAGService.cs @ 2026-04-09 12:35:32
```
﻿using System.Text;
using TextGenerator.Core.Interfaces.Memory;
using TextGenerator.Core.Interfaces.RAG;
...
---
#### TextGenerator.Infrastructure/RL/RLFineTuner.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Interfaces.EdgeAI;
using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/Reward/RewardCalculator.cs @ 2026-04-09 12:35:32
```
﻿using TextGenerator.Core.Interfaces.Memory;
using TextGenerator.Core.Interfaces.Processors;
...
---
#### TextGenerator.Infrastructure/Reward/RewardCollector.cs @ 2026-04-09 12:35:32
```
﻿using Newtonsoft.Json;
using TextGenerator.Core.Interfaces.Memory;
using TextGenerator.Core.Models.Feedback;
...
---
#### TextGenerator.Infrastructure/TextGenerator.Infrastructure.csproj @ 2026-04-09 12:35:32
```
﻿<Project Sdk="Microsoft.NET.Sdk">
...
---
#### TextGenerator.Service/Controllers/DialogueController.cs @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Service/Controllers/QuestController.cs @ 2026-04-09 12:35:32
```
﻿using Microsoft.AspNetCore.Mvc;
using TextGenerator.Core.Interfaces.Narrative;
using TextGenerator.Core.Models.Actors;
...
---
#### TextGenerator.Service/GPTTextGenerator.Service.http @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Service/Program.cs @ 2026-04-09 12:35:32
```
using TextGenerator.Core.Interfaces.Cache;
using TextGenerator.Core.Interfaces.EdgeAI;
using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Service/Properties/launchSettings.json @ 2026-04-09 12:35:32
```json
﻿{
...
---
#### TextGenerator.Service/TextGenerator.Service.csproj @ 2026-04-09 12:35:32
```
...
---
#### TextGenerator.Service/appsettings.Development.json @ 2026-04-09 12:35:32
```json
{
  "LLama": {
...
---
#### TextGenerator.Service/appsettings.json @ 2026-04-09 12:35:32
```json
{
  "LLama": {
    "ModelPath": "models/Meta-Llama-3-8B.Q4_K_M.gguf"
