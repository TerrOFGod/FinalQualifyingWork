...
│   │   ├── IllmPromptBuilderService.cs
│   │   └── IllmResponseParserService.cs
│   ├── RAG/
│   │   └── RAGService.cs
│   ├── RL/
│   │   └── ModelFineTuner.cs
...
## File Analysis @ 2026-04-09 14:02:02
- Total files: 64
- .cs: 56
- .csproj: 3
- .http: 1
...
---
#### Integrator.sln @ 2026-04-09 14:02:02
```
﻿
...
---
#### TextGenerator.Core/Common/Enums/ItemType.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Common/Enums/StatType.cs @ 2026-04-09 14:02:02
```
﻿namespace TextGenerator.Core.Common.Enums
{
...
---
#### TextGenerator.Core/Common/Enums/Status.cs @ 2026-04-09 14:02:02
```
﻿namespace TextGenerator.Core.Common.Enums
{
    public enum Status
...
---
#### TextGenerator.Core/Common/IEntity.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Interfaces/Cache/IDialogueCache.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Interfaces/EdgeAI/ILLMClient.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Interfaces/Memory/IEmbeddingGenerator.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Interfaces/Memory/IFeedbackCollector.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Interfaces/Memory/IRewardCalculator.cs @ 2026-04-09 14:02:02
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Memory/ITextSummarizer.cs @ 2026-04-09 14:02:02
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Memory/IVectorMemoryStore.cs @ 2026-04-09 14:02:02
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Narrative/INarrativeAgent.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Models.Actors;
using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Interfaces/Narrative/INarrativeEnvironment.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Interfaces/Processors/IDialogueValidator.cs @ 2026-04-09 14:02:02
```
﻿using System;
...
---
#### TextGenerator.Core/Interfaces/Processors/ILLMPromptBuilder.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Models.Actors;
using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Interfaces/Processors/ILLMResponseParser.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Models.Actors;
using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Interfaces/RAG/IRAGService.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Interfaces/RL/IModelFineTuner.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Models/Actions/GameAction.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Models/Actions/GameReaction.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Actions/SocialConnection.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Actors/Player.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Models/Actors/SmartNPC.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Models.Actions;
using TextGenerator.Core.Models.Interactions;
...
---
#### TextGenerator.Core/Models/Actors/WorldContext.cs @ 2026-04-09 14:02:02
```
﻿namespace TextGenerator.Core.Models.Actors;
...
---
#### TextGenerator.Core/Models/Feedback/InteractionFeedback.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Dialogues/DialogueEntry.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Dialogues/DialogueNode.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/Quest.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Models.Interactions.Dialogues;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/QuestChain.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/Requirement.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/Interactions/Quests/Reward.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Models.World;
...
---
#### TextGenerator.Core/Models/Metrics/PersonalizationMetrics.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Core/Models/World/GameObject.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/World/Inventory.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
...
---
#### TextGenerator.Core/Models/World/Item.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Common.Enums;
...
---
#### TextGenerator.Core/Models/World/Stat.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Common;
using TextGenerator.Core.Common.Enums;
...
---
#### TextGenerator.Core/TextGenerator.Core.csproj @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Infrastructure/Caching/DialogueCache.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Infrastructure/EdgeAI/LLamaSharpOptions.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Infrastructure/EdgeAI/LocalLLMClient.cs @ 2026-04-09 14:02:02
```
﻿using LLama;
using LLama.Common;
...
---
#### TextGenerator.Infrastructure/EdgeAI/ModelDownloader.cs @ 2026-04-09 14:02:02
```
﻿namespace TextGenerator.Infrastructure.EdgeAI;
...
---
#### TextGenerator.Infrastructure/Extensions/DialogueExtensions.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Models.Interactions;
using System;
using System.Collections.Generic;
...
---
#### TextGenerator.Infrastructure/Memory/EmbeddingGeneratorService.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Infrastructure/Memory/QdrantVectorMemoryStore.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Infrastructure/Memory/TextSummarizer.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/Narrative/Agents/NarrativeAgent.cs @ 2026-04-09 14:02:02
```
...
/// </summary>
    public class NarrativeAgent : INarrativeAgent
    {
        ...
        private readonly ILLMPromptBuilder _illmPromptBuilder;
        private readonly ILLMResponseParser _illmResponseParser;
        ...
        public NarrativeAgent(ILLMClient llm, ILLMPromptBuilder illmPromptBuilder, ILLMResponseParser illmResponseParser,
        ...
        {
            _llm = llm;
            _illmPromptBuilder = illmPromptBuilder;
            _illmResponseParser = illmResponseParser;
            _rag = rag;
            //_reward = reward;
        ...
        public async Task<DialogueEntry> GenerateDialogue(SmartNPC npc, Player player, string playerInput, int depth, int variety)
        {
            ...
            string prompt = _illmPromptBuilder.GenerateBasicSteppedDialogueRequest(npc, lastNode, variety, context);
            ...
            var nextNode = _illmResponseParser.DecodeSingleStepDialogueResponse(npc, rawResponse);
        ...
        {
            var prompt = _illmPromptBuilder.GenerateQuestPrompt(npc, player, goalDescription); // новый метод в IllmPromptBuilderService
            var rawQuest = await _llm.GenerateAsync(prompt);
            var quest = _illmResponseParser.ParseQuest(rawQuest);
...
---
#### TextGenerator.Infrastructure/Narrative/Environment/NarrativeEnvironmentService.cs @ 2026-04-09 14:02:02
```
﻿using Microsoft.Extensions.Caching.Memory;
using Neo4j.Driver;
using TextGenerator.Core.Interfaces.Narrative;
...
---
#### TextGenerator.Infrastructure/Processors/DialogueValidator.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Infrastructure/Processors/IllmPromptBuilderService.cs @ 2026-04-09 14:02:02
```
...
/// </summary>
public class IllmPromptBuilderService : ILLMPromptBuilder
{
    private readonly INarrativeEnvironment _narrativeEnv;

    public IllmPromptBuilderService(INarrativeEnvironment narrativeEnv)
    {
        _narrativeEnv = narrativeEnv;
    }
    ...
    public string GenerateBasicBranchedDialogueRequest(SmartNPC npc, int depth, int variety)
    {
        ...
        string characteristics = $"Personality traits: {string.Join(", ", npc.PersonalCharacteristics)}";
        string society = "Social connections: " + string.Join(", ", 
            npc.SocialConnections.Select(con => $"{con.RelatedNPC.Name} (connection type - {con.Type})"));
        string behavior = $"Behavior: {string.Join(", ", npc.Behaviors)}";
        ...
        return $"{entry}. {characteristics}. {society}. {behavior}. {branchesLimitation} Format as a numbered list. The list regex format: @\"(?<variant>\\d+(?:\\.\\d+)*)\\s+(?<playerName>\\w+)\\s*:\\s*\"\"(?<playerPhrase>[^\"\"]+)\"\"\\s+(?<npcName>\\w+)\\s*:\\s*\"\"(?<npcPhrase>[^\"\"]+)\"\"\". End value {endBranch}. First-level player options are numbers and are at the level of the introductory phrase, i.e. introduction 0, player options: 1, 2, .....";
    }
    ...
    public string GenerateQuestPrompt(SmartNPC npc, Player player, string goalDescription)
    {
        ...
        return $@"
You are a quest generator for an RPG. Generate a quest in JSON format.
NPC: {npc.Name} (profession: {npc.Profession})
Player: {player.Name}, level {player.Level}
Goal: {goalDescription}
World context: {JsonConvert.SerializeObject(context)}
Difficulty must be between 1 and 5, rewards can be items or experience.
Output ONLY JSON:
{{
  ""name"": ""Quest name"",
  ...
  ""rewards"": [{{""type"": ""exp"", ""amount"": 100}}]
    ...
    {
        string entry = $"Generate the next dialogue step for NPC {npc.Name}";
        string characteristics = $"Personality traits: {string.Join(", ", npc.PersonalCharacteristics)}";
        string society = "Social connections: " + string.Join(", ",
            npc.SocialConnections.Select(con => $"{con.RelatedNPC.Name} (connection type - {con.Type})"));
        string behavior = $"Behavior: {string.Join(", ", npc.Behaviors)}";
        string prevPlayerPhrase = $"Previous player dialogue phrase: {(prevNode != null ? "Player: " + prevNode.PlayerText : "")}\n";
        string prevNpcPhrase = $"Previous NPC dialogue phrase: {(prevNode != null ? npc.Name + ": " + prevNode.NPCText : "")}";
        string prevDialogueStep = $"{prevPlayerPhrase}{prevNpcPhrase}";
        List<string> list = new List<string>();
        for (int i = 0; i < variety; i++)
        {
            list.Add($"\n {i + 1}. Player: \"[Option {i + 1}]\" \n {npc.Name}: \"[Response to Option {i + 1}]\"");
        }

        string variantJoin = string.Join(" ", list);
        string formatter = $"Response must be in the format: {variantJoin}";
        string prompt = 
            $"{entry} (type - {npc.Type}, age - {npc.Age} years, appearance - {npc.Appearance}, profession - {npc.Profession}). {characteristics}. {society}. {behavior}. {prevDialogueStep}. {formatter}. Each phrase no longer than 2 sentences.";
    ...
    {
        string entry = $"Generate an introductory dialogue phrase for NPC {npc.Name}";
        string characteristics = $"Personality traits: {string.Join(", ", npc.PersonalCharacteristics)}";
        string society = "Social connections: " + string.Join(", ",
            npc.SocialConnections.Select(con => $"{con.RelatedNPC.Name} (connection type - {con.Type})"));
        string behavior = $"Behavior: {string.Join(", ", npc.Behaviors)}";
        string prompt = $"{entry} (type - {npc.Type}, age - {npc.Age} years, appearance - {npc.Appearance}, profession - {npc.Profession}). {characteristics}. {society}. {behavior}. Output only the phrase. No more than 2 sentences.";
    ...
    private string GenerateBranchesLimitationString(SmartNPC npc, int depth, int variety)
    {
        ...
        string entry = $"Suggest an introduction from NPC '{npc.Name}' as level 0.";
        cond.Add(entry);
        for (int i = 0; i < depth; i++)
        {
            string level = 
                $"At level {i + 1}, provide {variety} player response options{(i + 1 == 1 ? "" : " for each previous player option")}, and NPC '{npc.Name}' must respond to each player phrase{(i + 1 == depth ? "." : ", ")}";
            cond.Add(level);
        }
        return $"{string.Join(" ", cond)} ensuring all {Math.Pow(variety, depth)} possible dialogue branches.";
    }

    private string GenerateEntryString(SmartNPC npc)
    {
        return $"Create a branched dialogue with NPC named '{npc.Name}', type '{npc.Type}', age {npc.Age} years, appearance - {npc.Appearance}, profession - {npc.Profession}";
    }
}
```

---
#### TextGenerator.Infrastructure/Processors/IllmResponseParserService.cs @ 2026-04-09 14:02:02
```
﻿using System.Text.RegularExpressions;
using Newtonsoft.Json;
using TextGenerator.Core.Interfaces.Processors;
...
/// </summary>
public class IllmResponseParserService : ILLMResponseParser
{
...
---
#### TextGenerator.Infrastructure/RAG/RAGService.cs @ 2026-04-09 14:02:02
```
﻿using System.Text;
using TextGenerator.Core.Interfaces.Memory;
using TextGenerator.Core.Interfaces.RAG;
...
---
#### TextGenerator.Infrastructure/RL/ModelFineTuner.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Interfaces.EdgeAI;
using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/Reward/FeedbackCollector.cs @ 2026-04-09 14:02:02
```
﻿using Newtonsoft.Json;
using TextGenerator.Core.Interfaces.Memory;
using TextGenerator.Core.Models.Feedback;
...
---
#### TextGenerator.Infrastructure/Reward/RewardCalculator.cs @ 2026-04-09 14:02:02
```
﻿using TextGenerator.Core.Interfaces.Memory;
using TextGenerator.Core.Interfaces.Processors;
...
---
#### TextGenerator.Infrastructure/TextGenerator.Infrastructure.csproj @ 2026-04-09 14:02:02
```
﻿<Project Sdk="Microsoft.NET.Sdk">
...
---
#### TextGenerator.Service/Controllers/DialogueController.cs @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Service/Controllers/QuestController.cs @ 2026-04-09 14:02:02
```
﻿using Microsoft.AspNetCore.Mvc;
using TextGenerator.Core.Interfaces.Narrative;
using TextGenerator.Core.Models.Actors;
...
---
#### TextGenerator.Service/GPTTextGenerator.Service.http @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Service/Program.cs @ 2026-04-09 14:02:02
```
using TextGenerator.Core.Interfaces.Cache;
using TextGenerator.Core.Interfaces.EdgeAI;
using TextGenerator.Core.Interfaces.Memory;
...
builder.Services.AddScoped<ILLMPromptBuilder, IllmPromptBuilderService>();
builder.Services.AddScoped<ILLMResponseParser, IllmResponseParserService>();
...
---
#### TextGenerator.Service/Properties/launchSettings.json @ 2026-04-09 14:02:02
```json
﻿{
...
---
#### TextGenerator.Service/TextGenerator.Service.csproj @ 2026-04-09 14:02:02
```
...
---
#### TextGenerator.Service/appsettings.Development.json @ 2026-04-09 14:02:02
```json
{
  "LLama": {
...
---
#### TextGenerator.Service/appsettings.json @ 2026-04-09 14:02:02
```json
{
  "LLama": {
    "ModelPath": "models/Meta-Llama-3-8B.Q4_K_M.gguf"
