...
## File Analysis @ 2026-04-07 17:08:36
- Total files: 64
- .cs: 56
- .csproj: 3
- .http: 1
...
---
#### Integrator.sln @ 2026-04-07 17:08:36
```
﻿
...
---
#### TextGenerator.Core/Enums/ItemType.cs @ 2026-04-07 17:08:36
```
﻿using System;
...
---
#### TextGenerator.Core/Enums/StatType.cs @ 2026-04-07 17:08:36
```
﻿using System;
using System.Collections.Generic;
using System.Linq;
...
---
#### TextGenerator.Core/Enums/Status.cs @ 2026-04-07 17:08:36
```
﻿using System;
using System.Collections.Generic;
using System.Linq;
...
---
#### TextGenerator.Core/Interfaces/Cache/IDialogueCache.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Interfaces/Database/IBase.cs @ 2026-04-07 17:08:36
```
﻿namespace TextGenerator.Core.Interfaces.Database
{
...
---
#### TextGenerator.Core/Interfaces/EdgeAI/ILLMClient.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Interfaces/Memory/IMemory.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Interfaces/Memory/IRewardCalculator.cs @ 2026-04-07 17:08:36
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Memory/IRewardCollector.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Interfaces/Memory/ISummarizer.cs @ 2026-04-07 17:08:36
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Memory/IVectorMemory.cs @ 2026-04-07 17:08:36
```
﻿namespace TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Core/Interfaces/Narrative/INarrativeAgent.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactors;
...
---
#### TextGenerator.Core/Interfaces/Narrative/INarrativeEnvironment.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Interfaces/Processors/IAnalyzer.cs @ 2026-04-07 17:08:36
```
﻿using System;
using System.Collections.Generic;
using System.Linq;
...
---
#### TextGenerator.Core/Interfaces/Processors/IPostprocessor.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactors;
...
---
#### TextGenerator.Core/Interfaces/Processors/IPreprocessor.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Models.Interactions;
using TextGenerator.Core.Models.Interactors;
...
---
#### TextGenerator.Core/Interfaces/RAG/IRAGService.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Interfaces/RL/IRLFineTuner.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Models/Actions/Action.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Actions/Reaction.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Actions/Requirement.cs @ 2026-04-07 17:08:36
```
﻿using System;
using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Actions/SocialConnection.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
using TextGenerator.Core.Models.Interactors;
...
---
#### TextGenerator.Core/Models/Feedback/InteractionFeedback.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces.Database;

namespace TextGenerator.Core.Models.Feedback;

public class InteractionFeedback : IBase
{
...
---
#### TextGenerator.Core/Models/Interactions/ChainQuest.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Interactions/DialogueEntry.cs @ 2026-04-07 17:08:36
```
﻿using System.Collections.Generic;
using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Interactions/DialogueNode.cs @ 2026-04-07 17:08:36
```
﻿using System.Collections.Generic;
using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Interactions/Quest.cs @ 2026-04-07 17:08:36
```
﻿using System.Collections.Generic;
using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Interactors/Environment.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Models.Interactors;
using System.Collections.Generic;
using TextGenerator.Core.Interfaces;
...
---
#### TextGenerator.Core/Models/Interactors/Player.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Models/Interactors/SmartNPC.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
using TextGenerator.Core.Models.Actions;
...
---
#### TextGenerator.Core/Models/Interactors/WorldContext.cs @ 2026-04-07 17:08:36
```
﻿namespace TextGenerator.Core.Models.Interactors;
...
---
#### TextGenerator.Core/Models/Metrics/PersonalizationMetrics.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Core/Models/Misc/PObject.cs @ 2026-04-07 17:08:36
```
﻿using System.Collections.Generic;
...
---
#### TextGenerator.Core/Models/Misc/Stat.cs @ 2026-04-07 17:08:36
```
﻿using System;
using TextGenerator.Core.Enums;
using TextGenerator.Core.Interfaces;
...
---
#### TextGenerator.Core/Models/Objects/Inventory.cs @ 2026-04-07 17:08:36
```
﻿using System.Collections.Generic;
using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Objects/Item.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Enums;
using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/Models/Objects/Reward.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces;
using TextGenerator.Core.Interfaces.Database;
...
---
#### TextGenerator.Core/TextGenerator.Core.csproj @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Infrastructure/Agents/NarrativeAgent.cs @ 2026-04-07 17:08:36
```
...
namespace TextGenerator.Infrastructure.Agents;
    ...
    public class NarrativeAgent : INarrativeAgent
    {
        ...
        public NarrativeAgent(ILLMClient llm, IPreprocessor preprocessor, IPostprocessor postprocessor,
            IRAGService rag, IRewardSystem reward, ISummarizer summarizer, IMemoryCache cache, INarrativeEnvironment narrativeEnv)
        {
            _llm = llm;
...
---
#### TextGenerator.Infrastructure/Analyzer/Analyzer.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Infrastructure/Caching/DialogueCache.cs @ 2026-04-07 17:08:36
```
﻿using Microsoft.Extensions.Caching.Memory;
...
---
#### TextGenerator.Infrastructure/EdgeAI/LocalLLMClient.cs @ 2026-04-07 17:08:36
```
﻿using LLama;
using LLama.Common;
...
---
#### TextGenerator.Infrastructure/EdgeAI/ModelDownloader.cs @ 2026-04-07 17:08:36
```
﻿namespace TextGenerator.Infrastructure.EdgeAI;
...
---
#### TextGenerator.Infrastructure/Extensions/DialogueExtension.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Models.Interactions;
using System;
using System.Collections.Generic;
...
---
#### TextGenerator.Infrastructure/Memory/QdrantMemory.cs @ 2026-04-07 17:08:36
```
...
namespace TextGenerator.Infrastructure.Memory;
    ...
    public class QdrantMemory : IMemory
    {
        ...
        {
            // ... поиск, затем из payload извлечь "timestamp" как long (Unix) и конвертировать в DateTime
...
---
#### TextGenerator.Infrastructure/Memory/Summarizer.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/Memory/VectorMemoryService.cs @ 2026-04-07 17:08:36
```
﻿using Microsoft.ML.OnnxRuntime;
using Microsoft.ML.OnnxRuntime.Tensors;
using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/RL/RLFineTuner.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces.EdgeAI;
using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/Reward/RewardCalculator.cs @ 2026-04-07 17:08:36
```
﻿using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Infrastructure/Reward/RewardCollector.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Infrastructure/Services/NarrativeEnvironmentService.cs @ 2026-04-07 17:08:36
```
﻿using Microsoft.Extensions.Caching.Memory;
using Neo4j.Driver;
using TextGenerator.Core.Interfaces.Narrative;
...
---
#### TextGenerator.Infrastructure/Services/Processors/PostprocessorService.cs @ 2026-04-07 17:08:36
```
﻿using System.Text.RegularExpressions;
using Newtonsoft.Json;
using TextGenerator.Core.Interfaces.Processors;
...
---
#### TextGenerator.Infrastructure/Services/Processors/PreprocessorService.cs @ 2026-04-07 17:08:36
```
﻿using Newtonsoft.Json;
using TextGenerator.Core.Interfaces.Narrative;
using TextGenerator.Core.Interfaces.Processors;
...
---
#### TextGenerator.Infrastructure/Services/RAG/RAGService.cs @ 2026-04-07 17:08:36
```
﻿using System.Text;
using TextGenerator.Core.Interfaces.Memory;
using TextGenerator.Core.Interfaces.RAG;
...
---
#### TextGenerator.Infrastructure/TextGenerator.Infrastructure.csproj @ 2026-04-07 17:08:36
```
﻿<Project Sdk="Microsoft.NET.Sdk">
...
---
#### TextGenerator.Service/Controllers/DialogueController.cs @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Service/Controllers/QuestController.cs @ 2026-04-07 17:08:36
```
﻿using Microsoft.AspNetCore.Mvc;
using TextGenerator.Core.Interfaces.Narrative;
using TextGenerator.Core.Models.Interactions;
...
---
#### TextGenerator.Service/GPTTextGenerator.Service.http @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Service/Program.cs @ 2026-04-07 17:08:36
```
using TextGenerator.Core.Interfaces.Cache;
using TextGenerator.Core.Interfaces.EdgeAI;
using TextGenerator.Core.Interfaces.Memory;
...
---
#### TextGenerator.Service/Properties/launchSettings.json @ 2026-04-07 17:08:36
```json
﻿{
...
---
#### TextGenerator.Service/TextGenerator.Service.csproj @ 2026-04-07 17:08:36
```
...
---
#### TextGenerator.Service/appsettings.Development.json @ 2026-04-07 17:08:36
```json
{
  "LocalLLM": {
...
---
#### TextGenerator.Service/appsettings.json @ 2026-04-07 17:08:36
```json
{
  "LocalLLM": {
    "ModelPath": "models/llama-3-8b-q4.gguf"
